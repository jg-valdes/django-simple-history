...
class GetHistoryManagerTestCase(TestCase):
    ...
    def test_get_history_manager_for_model_default(self):
        ...
        self.assertEqual(str(manager.__class__), "<class 'django.db.models.manager.HistoryManagerFromHistoricalQuerySet'>")
    ...
    def test_get_history_manager_for_model_custom_manager(self):
        ...
        manager = get_history_manager_for_model(poll)
        self.assertEqual(str(manager.__class__), "<class 'django.db.models.manager.CustomHistoryManagerFromHistoricalQuerySet'>")
